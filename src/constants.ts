...
export const MUSIC_ARTISTS = [
  ...
  { id: 'mobb-deep', name: 'MOBB DEEP', sub: '90s East Coast / Gritty', weirdness: 15, styleInfluence: 90 },
  { id: 'nas', name: 'NAS', sub: '90s East Coast / Boom Bap', weirdness: 12, styleInfluence: 88 },
  { id: 'reda-taliani', name: 'REDA TALIANI', sub: 'Raï Algérien / Festive', weirdness: 18, styleInfluence: 80 },
  { id: 'cheb-hasni', name: 'CHEB HASNI', sub: 'Raï Algérien / Emotional', weirdness: 10, styleInfluence: 88 },
  { id: 'khaled', name: 'KHALED', sub: 'Raï Algérien / King of Raï', weirdness: 12, styleInfluence: 85 },
  { id: 'drake', name: 'DRAKE', sub: 'Melodic Rap / R&B', weirdness: 15, styleInfluence: 82 },
  { id: 'sza', name: 'SZA', sub: 'Modern R&B / Soul', weirdness: 20, styleInfluence: 80 },
  { id: 'sawano', name: 'HIROYUKI SAWANO', sub: 'Epic Anime / Orchestral', weirdness: 28, styleInfluence: 85 },
  { id: 'nujabes', name: 'NUJABES', sub: 'Lo-fi / Jazz Hop', weirdness: 20, styleInfluence: 82 },
  { id: 'newjeans', name: 'NEWJEANS', sub: 'K-Pop / Y2K', weirdness: 22, styleInfluence: 78 },
  { id: 'mhd', name: 'MHD', sub: 'Afro Trap', weirdness: 15, styleInfluence: 82 },
  { id: 'pinkpantheress', name: 'PINKPANTHERESS', sub: 'UK Garage / Alt-Pop', weirdness: 25, styleInfluence: 75 },
  ...
  { id: 'yamashita', name: 'TATSURO YAMASHITA', sub: 'City Pop / Disco', weirdness: 15, styleInfluence: 85 },
  { id: 'gilberto', name: 'ASTRUD GILBERTO', sub: 'Bossa Nova', weirdness: 10, styleInfluence: 88 },
  ...
  { id: 'tayc', name: 'TAYC', sub: 'Afro-R&B / Sensual', weirdness: 15, styleInfluence: 82 },
  ...
  { id: 'stromae', name: 'STROMAE', sub: 'Electro-World / Rumba Congolaise', weirdness: 30, styleInfluence: 82 },
  ...
  { id: 'woodkid', name: 'WOODKID', sub: 'Epic / Cinematic', weirdness: 30, styleInfluence: 78 },
  ...
  { id: 'tame-impala', name: 'TAME IMPALA', sub: 'Psychedelic Pop', weirdness: 32, styleInfluence: 78 },
  ...
  { id: 'soolking', name: 'SOOLKING', sub: 'Algerian Pop / Raï / Melodic', weirdness: 14, styleInfluence: 80 },
