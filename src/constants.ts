...
export const MUSIC_ARTISTS = [
  ...
  { id: 'jul', name: 'JUL', sub: 'Marseille / High Energy', weirdness: 15, styleInfluence: 85 },
  { id: 'pnl', name: 'PNL', sub: 'Cloud Rap / Éthéré / Autotune', weirdness: 40, styleInfluence: 85 },
  { id: 'nekfeu', name: 'NEKFEU', sub: 'Boom-Bap Pop-Rap / Poétique', weirdness: 15, styleInfluence: 80 },
  { id: 'orelsan', name: 'ORELSAN', sub: 'Alt-Rap Électronique / Skread', weirdness: 20, styleInfluence: 78 },
  ...
  { id: 'alpha-wann', name: 'ALPHA WANN', sub: 'Don Dada / Boom-Bap Purist', weirdness: 8, styleInfluence: 90 },
