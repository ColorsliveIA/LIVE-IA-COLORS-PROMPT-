...
const SONIC_DNA_MAP: Record<string, SonicDNA> = {
  ...
  'SDM': {
    artist: 'SDM',
    sunoStyleTemplate: 'French Trap, Dark Melodic Drill, Minimal Street Rap, Nocturnal Cold Urban Atmosphere, Deep Masculine Voice, Heavy Metallic Autotune on Hooks, 130-150 BPM, Key: F Minor, Heavy 808 Sub-Bass Sliding, Dark Somber Piano, Glacial Icy Synths, Airy Ethereal Textures, Crisp Drill Hi-Hats, Minimal Arrangement Cold Space, Introspective Yet Arrogant Delivery, Paris Nocturne Urbain, 2020s',
    ...
    sunoWeirdness: 30,
    sunoStyleInfluence: 85,
    sunoExcludeStyles: 'afro-trap, afrobeats, afro percussion, dancehall bounce, tropical house, bright bubblegum pop, cheerful happy, acoustic folk, R&B ballad smooth, reggaeton dembow, country twang, jazz smooth, rock distortion, punk, metal screaming, gospel choir, warm festive, EDM drops',
    vocalDNA: 'Deep masculine voice, cold and controlled. Rap-dominant on verses with staccato minimal flow. Hooks use heavy metallic autotune — dark and glacial, NOT warm or smooth. Arrogant but introspective tone. Never purely singing, never crooner, never afro melodic.',
    ...
    culturalAnchors: 'Paris banlieue nocturnal life, cold urban solitude, arrogant street success, introspective darkness, loyalty codes, Île-de-France concrete jungle, night drives, cold ambition',
    ...
    antiPatterns: 'NEVER afro-trap or afrobeats influence. NEVER warm festive bounce. NEVER Brussels or Belgian references. NEVER smooth R&B crooner. NEVER nonchalant laid-back like DAMSO. NEVER dancehall or tropical. Production must stay COLD and MINIMAL — no warm analog, no afro percussion.',
