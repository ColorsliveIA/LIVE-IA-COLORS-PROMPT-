...
const SONIC_DNA_MAP: Record<string, SonicDNA> = {
  ...
  'SOOLKING': {
    ...
    productionMarkers: 'raï melodic elements (derbouka, oud samples), modern pop-trap drums, Mediterranean melodic hooks, clean bright mix, moderate arrangement density, fusion traditional-modern',
    hookStrategy: 'melodic sung hook with raï inflection, Mediterranean brightness, high catchiness, moderate repetition, luminous emotional uplift, accessible pop structure',
    verseBehavior: 'melodic rap-singing with Algerian accent, raï vocal ornaments, smooth Mediterranean delivery, moderate pace, bright emotional tone, never dark or aggressive',
  ...
  'CHEB MAMI': {
    ...
    productionMarkers: 'traditional raï instruments (gasba flute, derbouka, oud), organic live percussion, simple harmonic progressions, acoustic arrangement, vocal-centered mix, traditional song structure',
    hookStrategy: 'high tenor vocal hook with raï melisma, traditional vocal ornaments as hook, emotional sustained notes, repeat melodic phrase, organic acoustic backdrop',
    verseBehavior: 'traditional raï vocal delivery, high tenor projection, emotional melisma and ornaments, organic phrasing with live musician feel, sustained notes, no rap elements',
  ...
  'DJALIL PALERMO': {
    ...
    sunoWeirdness: 35,
    sunoStyleInfluence: 80,
    sunoExcludeStyles: 'no pure traditional raï only, no Western acoustic folk, no boom bap drums, no experimental ambient, no bright bubblegum pop, no heavy metal',
    ...
    productionMarkers: 'modern trap drums with raï melodic samples, 808 bass with raï oud/synth melody, hybrid arrangement density, street-meets-traditional production, clean modern mix',
    hookStrategy: 'melodic hook blending trap melody with raï vocal inflection, moderate repetition, street energy with nostalgic undertone, sung hook with youth energy',
    verseBehavior: 'trap-influenced rap delivery with Algerian accent, street energy, moderate pace, raï vocal ornaments on transitions, youth directness in tone',
  ...
  'TIF': {
    ...
    energyCurve: 'Wave dynamics — builds from verse to hook',
    productionMarkers: 'raï-trap fusion production, oriental melodic synths, modern trap 808 pattern, nostalgic Mediterranean atmosphere, moderate density, blend of electronic and traditional textures',
    hookStrategy: 'nostalgic melodic hook with raï ornamentation, emotional Mediterranean melody, moderate repetition, melancholic beauty, sung delivery with oriental inflection',
    verseBehavior: 'melodic rap-singing with raï influence, nostalgic emotional delivery, Algerian accent, moderate pace, oriental vocal ornaments, sincere emotional projection',
  ...
  'NIRO': {
    artist: 'NIRO',
    sunoStyleTemplate: 'Raw French Street Rap, Aggressive Emotional Rap Brut, Blois Hardcore Energy, Deep Angry Male Voice, No Autotune No Singing, 120-135 BPM, Key: Bb Minor, Heavy Punchy 808, Dark Piano Loops, Aggressive Trap Drums, Minimal Dark Arrangement, Raw Close-Mic Recording, Street Rage Authenticity, 2010s-2020s',
    sunoBpmRange: '120-135',
    sunoKey: 'Bb Minor',
    sunoVocalTags: ['Deep Angry Voice', 'No Autotune', 'Raw Aggressive Delivery', 'Street Rage Projection'],
    sunoWeirdness: 25,
    sunoStyleInfluence: 80,
    sunoExcludeStyles: 'no melodic singing, no autotune processing, no bright cheerful production, no soft R&B chords, no experimental ambient, no playful ironic delivery',
    vocalDNA: 'Deep angry male voice, raw and unprocessed. NO autotune, NO melodic singing, NO vocoder. Pure rap brut — cru et énervé. Voice projects rage and frustration with genuine street intensity. Close-mic raw recording feel. Delivery gets more aggressive as verse builds.',
    flowPattern: 'Aggressive raw rap flow, building intensity. Starts controlled then erupts. Percussive hard consonant attacks. Breath-heavy at peak rage moments. Never smooth, never laid-back — always tension.',
    productionFingerprint: 'Signature: heavy punchy 808, dark minor piano loops, aggressive trap drums with hard snare, minimal arrangement — voice dominates everything, dark raw atmosphere, no polish',
    culturalAnchors: 'Blois street life, overlooked city rage, raw authenticity, genuine frustration, street survival, unfiltered emotion, Nord energy',
    structureDNA: 'Verse-hook-verse. Dense aggressive verses (16+ bars). Hook is a raw repeated phrase — shouted not sung. Build intensity throughout.',
    hookType: 'Raw shouted chant hook — repeated aggressive phrase, NO melody, NO singing, street slogan energy',
    vocalPlacement: 'Dry forward close-mic, raw in mix, voice dominates, aggressive presence',
    energyCurve: 'Escalating aggression — starts tense, builds to rage peak, never drops to calm',
    productionMarkers: 'heavy punchy 808 with aggressive attack, dark minor piano loop sparse, hard snare hits, aggressive trap hi-hats, minimal arrangement — raw voice over dark beat, no ambient pads, no polish, street recording energy',
    hookStrategy: 'raw shouted repeated phrase as hook, NO melodic variation, NO singing, street rage slogan, aggressive repetition, energy peak on hook — louder harder rawer',
    verseBehavior: 'aggressive raw rap delivery building through verse, hard consonant attacks, increasing intensity, breath-heavy at peaks, genuine rage projection, percussive delivery, no smooth transitions — raw cuts between ideas',
    antiPatterns: 'NEVER autotune. NEVER melodic singing. NEVER smooth or laid-back. NEVER polished pop production. This is RAP BRUT — cru, énervé, direct. Voice is unprocessed rage.',
    sunoMetatags: { vocalStyle: 'Raw Aggressive Street Rap', vocalEffect: 'Dry, No Autotune, Minimal Processing', mood: 'Angry, Raw, Frustrated, Intense', energy: 'High Escalating', texture: 'Raw Dark Minimal', instrument: 'Heavy 808, Dark Piano, Hard Snare, Aggressive Hi-Hats' }
  },
