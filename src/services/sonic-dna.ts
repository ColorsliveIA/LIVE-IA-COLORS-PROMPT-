...
const CORPUS_CURSORS: Record<string, CursorOverrides> = {
  ...
  // ── SPRINT 6 — CORPUS EXPANSION (FR rap) ──
  VALD:         { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'concept-fictional', referenceDensity: 75, technicityMode: 'virtuoso',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'drill-fr-cold' },
  SDM:          { compositionMode: 'hook-driven',  registerMode: 'combative',     conceptualMode: 'narrative-real',  referenceDensity: 30, technicityMode: 'standard',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'drill-fr-cold' },
  NISKA:        { compositionMode: 'hook-driven',  registerMode: 'combative',     conceptualMode: 'non-narrative',   referenceDensity: 25, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'afro-trap-melodic' },
  KALASH:       { compositionMode: 'hook-driven',  registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'gospel-kalimba-afro', territorialAnchor: { lang: 'creole', density: 30, role: 'lexical' } },
  MAES:         { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'narrative-real',  referenceDensity: 40, technicityMode: 'standard',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'mystic-orchestral-808', territorialAnchor: { lang: 'arabe', density: 20, role: 'lexical' } },
  WERENOI:      { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'narrative-real',  referenceDensity: 50, technicityMode: 'standard',         honorCode: 'central',  tempoGravity: 'slow', harmonicProfileId: 'mystic-orchestral-808' },
  MHD:          { compositionMode: 'hook-driven',  registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'afro-trap-melodic' },
  DADJU:        { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'non-narrative',   referenceDensity: 15, technicityMode: 'standard',         honorCode: 'none',     tempoGravity: 'mid',  harmonicProfileId: 'cloud-rnb-velvet' },
  TAYC:         { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'none',     tempoGravity: 'mid',  harmonicProfileId: 'cloud-rnb-velvet' },
  ANGELE:       { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'narrative-real',  referenceDensity: 60, technicityMode: 'standard',         honorCode: 'none',     tempoGravity: 'mid',  harmonicProfileId: 'pop-chanson-acoustic' },
  STROMAE:      { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'narrative-real',  referenceDensity: 75, technicityMode: 'virtuoso',         honorCode: 'none',     tempoGravity: 'mid',  harmonicProfileId: 'pop-chanson-acoustic' },
  'AYA NAKAMURA': { compositionMode: 'hook-driven', registerMode: 'hybrid',       conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'none',     tempoGravity: 'mid',  harmonicProfileId: 'afro-trap-melodic' },
  SOOLKING:     { compositionMode: 'melody-first', registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 25, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'rai-mediterranean-vintage', territorialAnchor: { lang: 'arabe', density: 35, role: 'both' } },
  NIRO:         { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'narrative-real',  referenceDensity: 45, technicityMode: 'standard',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'mystic-orchestral-808' },
  TIF:          { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'non-narrative',   referenceDensity: 25, technicityMode: 'standard',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'drill-fr-cold' },
  'BILAL SGHIR':{ compositionMode: 'melody-first', registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'rai-mediterranean-vintage', territorialAnchor: { lang: 'arabe', density: 70, role: 'both' } },
  'CHEB MAMI':  { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'non-narrative',   referenceDensity: 15, technicityMode: 'virtuoso',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'rai-mediterranean-vintage', territorialAnchor: { lang: 'arabe', density: 80, role: 'both' } },
  'DJALIL PALERMO': { compositionMode: 'melody-first', registerMode: 'hybrid',    conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'rai-mediterranean-vintage', territorialAnchor: { lang: 'arabe', density: 60, role: 'both' } },
  'JOE DWET FILE': { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'non-narrative', referenceDensity: 15, technicityMode: 'standard',       honorCode: 'none',     tempoGravity: 'mid',  harmonicProfileId: 'cloud-rnb-velvet' },
  AUGXST:       { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'non-narrative',   referenceDensity: 30, technicityMode: 'standard',         honorCode: 'none',     tempoGravity: 'slow', harmonicProfileId: 'cloud-rnb-velvet' },
  HUGEL:        { compositionMode: 'hook-driven',  registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 10, technicityMode: 'standard',         honorCode: 'none',     tempoGravity: 'fast', harmonicProfileId: 'gospel-kalimba-afro' },

  // ── SPRINT 6 — CORPUS EXPANSION (international) ──
  DRAKE:        { compositionMode: 'melody-first', registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 35, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'cloud-rnb-velvet' },
  'TRAVIS SCOTT': { compositionMode: 'hook-driven', registerMode: 'hybrid',       conceptualMode: 'non-narrative',   referenceDensity: 25, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'synth-retro-futur' },
  'KENDRICK LAMAR': { compositionMode: 'text-first', registerMode: 'contemplative', conceptualMode: 'narrative-real', referenceDensity: 90, technicityMode: 'virtuoso',       honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'conscient-jazz-soul' },
  ...
  WIZKID:       { compositionMode: 'melody-first', registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'afro-trap-melodic' },
  'BURNA BOY':  { compositionMode: 'melody-first', registerMode: 'hybrid',        conceptualMode: 'narrative-real',  referenceDensity: 35, technicityMode: 'virtuoso',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'afro-trap-melodic' },
  TEMS:         { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'non-narrative',   referenceDensity: 25, technicityMode: 'virtuoso',         honorCode: 'none',     tempoGravity: 'slow', harmonicProfileId: 'cloud-rnb-velvet' },
  ASAKE:        { compositionMode: 'hook-driven',  registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'mid',  harmonicProfileId: 'afro-trap-melodic' },
  'JORJA SMITH':{ compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'narrative-real',  referenceDensity: 45, technicityMode: 'virtuoso',         honorCode: 'none',     tempoGravity: 'slow', harmonicProfileId: 'cloud-rnb-velvet' },
  SZA:          { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'narrative-real',  referenceDensity: 50, technicityMode: 'virtuoso',         honorCode: 'none',     tempoGravity: 'mid',  harmonicProfileId: 'cloud-rnb-velvet' },
  'SNOH AALEGRA': { compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'narrative-real', referenceDensity: 55, technicityMode: 'virtuoso',       honorCode: 'none',     tempoGravity: 'slow', harmonicProfileId: 'jazz-soul-rhodes' },
  NAS:          { compositionMode: 'text-first',   registerMode: 'contemplative', conceptualMode: 'narrative-real',  referenceDensity: 90, technicityMode: 'virtuoso',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'boom-bap-piano-loop' },
  'MOBB DEEP':  { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'narrative-real',  referenceDensity: 70, technicityMode: 'virtuoso',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'boom-bap-piano-loop' },
  'JEDI MIND TRICKS': { compositionMode: 'text-first', registerMode: 'combative', conceptualMode: 'concept-fictional', referenceDensity: 95, technicityMode: 'virtuoso',      honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'boom-bap-piano-loop' },
  'NATE DOGG':  { compositionMode: 'melody-first', registerMode: 'hybrid',        conceptualMode: 'narrative-real',  referenceDensity: 40, technicityMode: 'standard',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'boom-bap-piano-loop' },
  'CENTRAL CEE':{ compositionMode: 'hook-driven',  registerMode: 'combative',     conceptualMode: 'narrative-real',  referenceDensity: 30, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'fast', harmonicProfileId: 'drill-fr-cold' },
