...
const SONIC_DNA_MAP: Record<string, SonicDNA> = {
  ...
  'SDM': {
    ...
    vocalDNA: 'Heavy metallic autotune with honeyed nasal crooner quality. Laid-back nonchalant delivery, never rushed. Deep masculine voice with rap dominance that shifts to sung passages.',
    ...
    productionFingerprint: 'Signature: filtered Rhodes chords, nocturnal atmospheric pads, heavy sliding 808 sub-bass, crisp digital trap drums, crisp hi-hats, lush reverb and delay, wide soundstage, expensive hi-end production',
    structureDNA: 'Standard verse-hook-verse with rap-dominant structure. Verses (14-16 bars). Dark atmospheric arrangement throughout.',
    ...
    culturalAnchors: 'Brussels street melancholy, nocturnal life, expensive sophisticated atmosphere, bitter success, loyalty, betrayal',
