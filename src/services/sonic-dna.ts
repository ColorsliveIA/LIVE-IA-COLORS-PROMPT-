...
const SONIC_DNA_MAP: Record<string, SonicDNA> = {
  ...
  'NIRO': {
    ...
    sunoWeirdness: 30,
    sunoStyleInfluence: 75,
    sunoExcludeStyles: 'no flat monotone delivery, no bright cheerful production, no experimental noise, no playful ironic tone, no lo-fi minimal sound, no standard pop structure',
    vocalDNA: 'Deep emotional male voice with sincere projection. Dramatic delivery that builds tension through the verse. Genuine emotional intensity — not flat, not monotone. Moderate autotune. Voice carries real weight and pain.',
    ...
    vocalPlacement: 'Floating in mix',
    energyCurve: 'Wave dynamics',
    productionMarkers: 'melancholic piano melodies with emotional weight, deep 808 sub, atmospheric strings for tension, trap drums with moderate pattern, dark ambient pads, moderate density building on emotional sections',
    hookStrategy: 'emotional melodic hook with vocal projection, dramatic delivery on hooks, tension build toward chorus, moderate melodic complexity, genuine emotional intensity — not manufactured',
    verseBehavior: 'emotional intensity building throughout verse, vocal projection increasing, dramatic delivery with tension arc, sincere earnest tone, breath-heavy at peak emotional moments, never monotone — dynamic emotional range',
