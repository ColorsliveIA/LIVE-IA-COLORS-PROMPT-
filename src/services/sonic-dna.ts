...
const SONIC_DNA_MAP: Record<string, SonicDNA> = {
  ...
  // ── SPRINT 7 — NEW ARTIST DNA ENTRIES ──

  'KERY JAMES': {
    artist: 'KERY JAMES',
    sunoStyleTemplate: 'Conscious French Rap, Militant Storytelling, Intense Lyrical Delivery, 85-95 BPM, Key: D Minor, Dark Orchestral Strings, Militant Piano Chords, Heavy Boom-Bap Drums, Atmospheric Tension Pads, Powerful Deep Male Voice, Raw Diction No Autotune, Social Activist Fury, 2000s-2020s',
    sunoBpmRange: '85-95',
    sunoKey: 'D Minor',
    sunoVocalTags: ['Powerful Deep Voice', 'Militant Delivery', 'Raw Diction No Autotune', 'Intense Emotional Range'],
    sunoWeirdness: 20,
    sunoStyleInfluence: 92,
    sunoExcludeStyles: 'no autotune, no melodic trap, no drill patterns, no pop hooks, no bright production, no club energy, no playful delivery',
    vocalDNA: 'Powerful deep male voice with intense projection. Raw natural diction — ZERO autotune, ZERO effects. Voice carries authority and conviction. Emotional range from controlled fury to intimate vulnerability. Theatrical delivery on climactic lines. Every word articulated with militant precision.',
    flowPattern: 'Dense lyrical delivery with building intensity. Long complex sentences flowing into punchy short conclusions. Theatrical pauses before key punchlines. Acceleration on passionate passages, deceleration on reflective moments. Never monotone — constant emotional modulation.',
    productionFingerprint: 'Signature: dark orchestral strings (tension-building), militant minor-key piano chords, heavy boom-bap drums (dusty, hard-hitting), atmospheric tension pads, occasional choir/vocal samples for dramatic peaks, cinematic arrangements',
    culturalAnchors: 'Social justice, banlieue reality, racism and discrimination, political consciousness, Islam and faith, French Republic hypocrisy, street survival with moral compass, generational trauma, hope through struggle',
    structureDNA: 'Long verses (16-20 bars) with dense content → shorter emotional hook → verse 2 escalates intensity → hook with slight variation → possible spoken outro/conclusion. Verses are the star, not hooks.',
    hookType: 'Chant hook with militant conviction — sometimes sung with raw emotion, sometimes repeated mantra-phrase',
    vocalPlacement: 'Center-forward dominant, close-mic, voice commanding the full mix, raw and unprocessed',
    energyCurve: 'Slow burn building to explosive peaks — starts measured, verse 2 erupts, climax on final verse, reflective outro',
    productionMarkers: 'dark orchestral string arrangements building tension, minor-key piano chords militant, heavy boom-bap drums dusty hard kick snare, atmospheric tension pads wide stereo, cinematic arrangements, sparse arrangement density — voice dominates, occasional dramatic choir stabs',
    hookStrategy: 'militant conviction chant hook, repeated powerful phrase as mantra, raw emotional singing on key hooks, NOT catchy pop — conviction-driven memorability, moderate repetition',
    verseBehavior: 'dense lyrical delivery with militant precision, long complex sentences, building intensity throughout, theatrical pauses before punchlines, acceleration on passionate passages, clear articulation — every syllable matters, no mumbling, no laziness',
    antiPatterns: 'NEVER autotune. NEVER trap production. NEVER superficial flex themes. NEVER playful or ironic tone. NEVER drill aggression without substance. NEVER fast for speed — fast for fury only.',
    sunoMetatags: { vocalStyle: 'Militant Conscious Rap', vocalEffect: 'No Effects, Raw Natural', mood: 'Militant, Passionate, Reflective, Furious', energy: 'Medium-High Building', texture: 'Dark Orchestral Cinematic', instrument: 'Orchestral Strings, Piano, Boom-Bap Drums, Atmospheric Pads' }
  },

  'SOFIANE': {
    artist: 'SOFIANE',
    sunoStyleTemplate: 'Street French Rap, Aggressive Punchline Rap, Raw Authentic Street Energy, 85-100 BPM, Key: C Minor, Dark Minimal Beat, Heavy 808 Bass, Hard Snare Boom-Bap Hybrid, Aggressive Piano Stabs, Deep Gravelly Male Voice, Raw No Autotune, Street Authenticity, 2010s-2020s',
    sunoBpmRange: '85-100',
    sunoKey: 'C Minor',
    sunoVocalTags: ['Deep Gravelly Voice', 'Aggressive Raw Delivery', 'No Autotune', 'Punchline Attack'],
    sunoWeirdness: 22,
    sunoStyleInfluence: 85,
    sunoExcludeStyles: 'no melodic singing, no autotune, no soft R&B, no pop hooks, no cloud rap, no experimental ambient',
    vocalDNA: 'Deep gravelly male voice with aggressive raw delivery. ZERO autotune — rawness is the weapon. Punchline-driven attack with sudden bursts of energy. Alternates between controlled menace and explosive outbursts. Street authenticity in every syllable. Slightly breathless on fast passages — physical effort audible.',
    flowPattern: 'Punchline-driven: setup lines build to devastating punch. Capable of both slow menacing delivery and rapid-fire bursts. Rhythmic emphasis on strong syllables. Breathing audible — physical rap.',
    productionFingerprint: 'Signature: dark minimal beats, heavy 808 bass with distortion, hard snare (boom-bap hybrid), aggressive piano stabs, occasional Middle-Eastern melodic samples, sparse arrangement — voice fills the space',
    culturalAnchors: 'Street life raw and unfiltered, Arab-French identity, banlieue loyalty, hustle and survival, authenticity over image, brotherhood code, humor through street wisdom',
    structureDNA: 'Verse 1 (aggressive, punchline-stacked) → Hook (simple memorable street phrase) → Verse 2 (escalation) → Hook → possible freestyle-feel outro. Punchlines are the architecture.',
    hookType: 'Simple street phrase chant hook — raw repeated conviction, NOT melodic',
    vocalPlacement: 'Center-forward aggressive, close-mic raw, slightly compressed for punch impact',
    energyCurve: 'Constant aggression with explosive peaks on key punchlines',
    productionMarkers: 'dark minimal beat foundation, heavy 808 bass with slight distortion, hard boom-bap hybrid snare, aggressive piano stabs sparse, occasional oriental melodic sample, low arrangement density — voice dominates, minimal production — rawness',
    hookStrategy: 'simple street phrase repeated with conviction, raw chant energy, NOT melodic hook — street mantra, moderate repetition, aggressive delivery on hook',
    verseBehavior: 'punchline-stacked aggressive delivery, setup-punch rhythm, alternating controlled menace and explosive bursts, breathing audible — physical effort, rapid-fire capable, street vocabulary dominant',
    antiPatterns: 'NEVER melodic singing. NEVER autotune. NEVER soft introspection without edge. NEVER pop production. NEVER clean polished mix.',
    sunoMetatags: { vocalStyle: 'Aggressive Street Rap', vocalEffect: 'No Effects, Raw Compressed', mood: 'Aggressive, Menacing, Street Authentic', energy: 'High Constant', texture: 'Dark Minimal Raw', instrument: 'Heavy 808, Hard Snare, Piano Stabs, Oriental Samples' }
  },

  'ZIAK': {
    artist: 'ZIAK',
    sunoStyleTemplate: 'French Jersey Drill, Masked Anonymous Rap, Bouncy Club Drill Fusion, Fast Rhythmic Delivery, 130-140 BPM, Key: F Minor, Jersey Club Kick Patterns, Chopped Vocal Samples, 808 Glide Bass, Fast Hi-Hats, Syncopated Drums, Masked Distorted Male Voice, Aggressive Autotune, Anonymous Dark Energy, 2020s',
    sunoBpmRange: '130-140',
    sunoKey: 'F Minor',
    sunoVocalTags: ['Masked Distorted Voice', 'Aggressive Autotune', 'Fast Rhythmic Delivery', 'Anonymous Menace'],
    sunoWeirdness: 45,
    sunoStyleInfluence: 88,
    sunoExcludeStyles: 'no slow ballad, no acoustic folk, no boom bap, no clean pop, no soft R&B, no conscious rap delivery',
    vocalDNA: 'Masked distorted male voice — identity concealed through vocal processing. Aggressive autotune as texture. Fast rhythmic delivery with staccato precision. Voice sounds muffled/filtered — as if through fabric. Energy is cold, nihilistic, anonymous. Ad-libs are percussive bursts.',
    flowPattern: 'Fast rhythmic delivery with jersey-drill bounce. Syncopated against the club-influenced drums. Staccato bursts followed by sustained aggressive phrases. Flow diversification — switches rhythm within same verse. Never monotone despite aggression.',
    productionFingerprint: 'Signature: jersey club kick patterns (bouncy, syncopated), chopped vocal samples (pitched, reversed), 808 glide bass, fast hi-hats, syncopated percussion, dark club atmosphere — drill meets jersey',
    culturalAnchors: 'Anonymous masked identity, nihilism, street menace, visual aesthetic (cagoule, noir), cold ambition, new generation drill-club fusion',
    structureDNA: 'Short intense verses (8-12 bars) → percussive hook → verse 2 with flow switch → hook → possible beat switch bridge. Fast-paced, no wasted bars.',
    hookType: 'Percussive chant hook with chopped vocal energy — bouncy and aggressive',
    vocalPlacement: 'Behind vocal processing, muffled/filtered presence, aggressive but veiled',
    energyCurve: 'Constant high energy — relentless bouncy aggression throughout',
    productionMarkers: 'jersey club syncopated kick pattern, chopped pitched vocal samples, 808 glide bass slides, fast hi-hat rolls, bouncy percussion, dark club atmosphere, moderate-high density, beat switches possible',
    hookStrategy: 'percussive bouncy hook, chopped vocal energy, aggressive repetition, club-drill fusion catchiness, high energy peak on hook, simple phrase with rhythmic impact',
    verseBehavior: 'fast rhythmic staccato delivery, jersey-drill bounce syncopation, flow diversification mid-verse, masked vocal processing, nihilistic cold energy, never monotone — rhythmic variation is key',
    antiPatterns: 'NEVER slow introspection. NEVER acoustic simplicity. NEVER face-reveal vulnerability. NEVER standard trap without jersey bounce. NEVER pop hooks.',
    sunoMetatags: { vocalStyle: 'Masked Aggressive Drill-Club', vocalEffect: 'Heavy Autotune, Vocal Distortion, Muffled Filter', mood: 'Nihilistic, Cold, Bouncy Aggressive', energy: 'High Constant', texture: 'Dark Club Jersey-Drill', instrument: 'Jersey Kick Pattern, 808 Glide, Chopped Vocals, Fast Hi-Hats' }
  },

  'FAVÉ': {
    artist: 'FAVÉ',
    sunoStyleTemplate: 'French Melodic Drill-Pop, Emotional Jersey Influence, Youthful Melodic Rap, 125-140 BPM, Key: Ab Minor, Soft Drill Bass, Melodic Guitar Loops, Jersey-Influenced Percussion, Airy Synth Pads, Young Melodic Male Voice, Emotional Autotune, Romantic Street Energy, 2020s',
    sunoBpmRange: '125-140',
    sunoKey: 'Ab Minor',
    sunoVocalTags: ['Young Melodic Voice', 'Emotional Autotune', 'Singing-Rap Hybrid', 'Romantic Street Delivery'],
    sunoWeirdness: 35,
    sunoStyleInfluence: 82,
    sunoExcludeStyles: 'no aggressive hard drill, no boom bap, no conscious rap, no dark minimal, no slow ballad, no heavy distortion',
    vocalDNA: 'Young melodic male voice with emotional autotune processing. Singing-rap hybrid — flows between rap verses and sung hooks seamlessly. Romantic undertones even in street themes. Lighter voice than typical drill artists — emotional vulnerability as strength.',
    flowPattern: 'Melodic flow with drill rhythm backbone. Emotional singing sections alternate with sharper rap delivery. Jersey-influenced bouncy phrasing. Capable of both intimate softness and energetic delivery.',
    productionFingerprint: 'Signature: soft drill bass (less aggressive 808), melodic guitar loops, jersey-influenced percussion patterns, airy synth pads, bright but emotional production, polished youthful energy',
    culturalAnchors: 'Youthful love and heartbreak, street reality with emotional depth, new generation identity, romantic street culture, Paris youth scene',
    structureDNA: 'Verse (melodic rap) → Sung hook (emotional, catchy) → Verse 2 (more intensity) → Hook → Bridge (softer, intimate) → Final hook. Hooks are the centerpiece.',
    hookType: 'Melodic autotune sung hook — emotional and catchy, accessible, romantic energy',
    vocalPlacement: 'Floating in mix with airy reverb, warm intimate presence',
    energyCurve: 'Wave dynamics — emotional ebbs and flows, builds to hook peaks',
    productionMarkers: 'soft drill bass 808 with less aggression, melodic guitar loop foundation, jersey-influenced bouncy percussion, airy synth pads, bright emotional mix, moderate density, polished youthful production',
    hookStrategy: 'emotional melodic autotune hook, catchy accessible singing, romantic street energy, high catchiness, moderate repetition, sing-along potential',
    verseBehavior: 'melodic rap flow with drill rhythm, emotional vulnerability in delivery, singing-rap transitions, jersey-influenced bouncy phrasing, intimate sections mixed with energetic delivery',
    antiPatterns: 'NEVER pure aggression without emotion. NEVER dark nihilism. NEVER purely spoken rap. NEVER slow boom-bap. NEVER heavy distorted production.',
    sunoMetatags: { vocalStyle: 'Emotional Melodic Drill-Pop', vocalEffect: 'Autotune, Light Reverb', mood: 'Romantic, Emotional, Youthful', energy: 'Medium-High', texture: 'Bright Emotional Drill', instrument: 'Guitar Loop, Soft 808 Bass, Jersey Percussion, Airy Synth Pads' }
  },

  '1PLIKE140': {
    artist: '1PLIKE140',
    sunoStyleTemplate: 'French Drill Hardcore, Cold Technical Drill, Aggressive Fast Flow, 140-150 BPM, Key: E Minor, Hard 808 Glide Bass, Fast Complex Hi-Hats, Dark Orchestral Samples Distorted, Aggressive Snare Reverb, Cold Aggressive Male Voice, Minimal Autotune, Fast Precise Drill Flow, Pure Aggression, 2020s',
    sunoBpmRange: '140-150',
    sunoKey: 'E Minor',
    sunoVocalTags: ['Cold Aggressive Voice', 'Fast Precise Flow', 'Minimal Autotune', 'Drill Staccato Attack'],
    sunoWeirdness: 35,
    sunoStyleInfluence: 90,
    sunoExcludeStyles: 'no melodic singing, no soft R&B, no pop hooks, no acoustic folk, no slow tempo, no cloud rap, no warm production',
    vocalDNA: 'Cold aggressive male voice with technical precision. Minimal autotune — rawness over polish. Fast drill flow with staccato syllable attacks. Controlled menace — never screaming, always precise. Voice projects cold confidence. French drill prototype vocal.',
    flowPattern: 'Fast precise drill flow — 140-150 BPM territory. Staccato syllable attacks on the offbeat. Technical precision in rapid delivery. Flow variation within verses — speed changes, rhythmic shifts. Breath control as a weapon — minimal pauses.',
    productionFingerprint: 'Signature: hard 808 glide bass (aggressive slides), fast complex hi-hat patterns, dark orchestral samples (distorted, eerie), aggressive snare with reverb tail, minimal melodic elements — percussion-driven darkness',
    culturalAnchors: 'French drill scene, street menace, cold ambition, competitive rap culture, Paris underground, collective identity',
    structureDNA: 'Verse 1 (aggressive, fast, technical) → Short hard hook → Verse 2 (flow switch, escalation) → Hook → possible beat switch outro. No soft moments.',
    hookType: 'Hard chant hook — aggressive repetition, percussive vocal attack, NOT melodic',
    vocalPlacement: 'Center-forward aggressive, tight compression, raw presence',
    energyCurve: 'Constant high aggression — no valleys, relentless intensity',
    productionMarkers: 'hard 808 glide bass aggressive slides, fast complex hi-hat patterns, dark orchestral samples distorted and eerie, aggressive snare with reverb, minimal melodic content, percussion-driven, high density aggressive mix',
    hookStrategy: 'hard aggressive chant hook, percussive repetition, cold menacing delivery, short and impactful, NOT melodic — rhythm-driven, high energy peak',
    verseBehavior: 'fast precise drill flow 140+ BPM, staccato syllable attacks, technical rapid delivery, flow variation and speed changes within verse, minimal pauses — breath control weapon, cold controlled menace throughout',
    antiPatterns: 'NEVER melodic. NEVER slow. NEVER emotional vulnerability. NEVER pop production. NEVER soft hooks. NEVER warm tones.',
    sunoMetatags: { vocalStyle: 'Cold Technical Drill Rap', vocalEffect: 'Minimal Autotune, Tight Compression', mood: 'Cold, Aggressive, Menacing', energy: 'High Constant', texture: 'Dark Percussion-Driven Drill', instrument: 'Hard 808 Glide, Fast Hi-Hats, Dark Orchestral Samples, Aggressive Snare' }
  },

  'LAURYN HILL': {
    artist: 'LAURYN HILL',
    sunoStyleTemplate: 'Neo-Soul Hip-Hop, Conscious R&B-Rap Fusion, Live Instrumentation Organic Soul, 80-100 BPM, Key: Bb Minor, Live Drums Organic Groove, Warm Bass Guitar, Rhodes Piano Chords, Acoustic Guitar, Horn Section, Rich Warm Female Alto-Soprano, Raw Emotional Singing and Rap, Gospel-Soul Inflection, 1990s-2000s',
    sunoBpmRange: '80-100',
    sunoKey: 'Bb Minor',
    sunoVocalTags: ['Rich Warm Alto-Soprano', 'Gospel-Soul Inflection', 'Singing and Rap Duality', 'Raw Emotional Power'],
    sunoWeirdness: 35,
    sunoStyleInfluence: 95,
    sunoExcludeStyles: 'no autotune, no trap 808, no drill patterns, no electronic production, no pop polish, no mumble rap, no fast aggressive delivery',
    vocalDNA: 'Rich warm female alto-soprano with gospel-soul inflection. Dual threat: powerful emotional singing AND sharp conscious rap delivery. Raw natural voice — ZERO effects processing. Gospel-trained vocal runs with restraint. Voice cracks and breaks are emotional tools. Caribbean patois inflection on certain passages. Commanding presence — silence when she speaks.',
    flowPattern: 'Sharp conscious rap flow on verses — rhythmic, articulate, intellectual. Powerful gospel-soul singing on hooks — transcendent. Seamless transitions between rap and song. Rhythmic emphasis rooted in hip-hop but soaked in soul tradition.',
    productionFingerprint: 'Signature: live drums with organic groove (swing, human feel), warm round bass guitar, Rhodes piano warm chords, acoustic guitar fingerpicked, horn section (trumpet, trombone), minimal electronic elements — LIVE band sound, Motown meets hip-hop',
    culturalAnchors: 'Black consciousness, love and heartbreak, feminine strength, spiritual journey, motherhood, societal critique, self-discovery, Caribbean heritage, hip-hop authenticity, musical integrity over commercial success',
    structureDNA: 'Verse (rap) → Hook (gospel-soul singing) → Verse 2 (deeper rap) → Hook (more emotional) → Bridge (intimate, stripped) → Final hook (full power). Live band arrangement — organic flow, not grid-locked.',
    hookType: 'Powerful gospel-soul sung hook — transcendent emotional power, natural voice',
    vocalPlacement: 'Center-forward commanding, natural reverb only, voice dominates the mix, warm intimate projection',
    energyCurve: 'Slow burn to explosive — starts intimate, builds through verse intensity, hooks are transcendent peaks, bridge strips back, finale explodes',
    productionMarkers: 'live organic drums with swing and human feel, warm round bass guitar groove, Rhodes piano warm chord voicings, acoustic guitar fingerpicked, horn section accents, minimal electronic — live band, moderate density organic mix, Motown-hip-hop hybrid',
    hookStrategy: 'powerful gospel-soul singing hook, transcendent emotional delivery, natural voice dominance, memorable melody rooted in soul tradition, moderate repetition, builds intensity on each return',
    verseBehavior: 'sharp conscious rap flow — articulate intellectual, rhythmic hip-hop delivery, seamless transitions to singing, Caribbean patois inflection occasional, emotional conviction in every word, never lazy — intentional delivery',
    antiPatterns: 'NEVER autotune. NEVER electronic production dominant. NEVER superficial themes. NEVER pop polish over soul. NEVER fast aggressive drill. NEVER mumble delivery.',
    sunoMetatags: { vocalStyle: 'Gospel-Soul Rap Fusion', vocalEffect: 'No Effects, Natural Reverb Only', mood: 'Conscious, Spiritual, Powerful, Intimate', energy: 'Medium Building to High', texture: 'Live Organic Soul-Hip-Hop', instrument: 'Live Drums, Bass Guitar, Rhodes Piano, Acoustic Guitar, Horn Section' }
  },

  'GUY2BEZBAR': {
    artist: 'GUY2BEZBAR',
    sunoStyleTemplate: 'French Street Trap, Aggressive Melodic Trap, Raw Street Energy, 130-145 BPM, Key: G Minor, Heavy Distorted 808, Dark Synth Stabs, Trap Hi-Hat Rolls, Aggressive Snare, Deep Aggressive Male Voice, Light Aggressive Autotune, Street Menace Energy, 2020s',
    sunoBpmRange: '130-145',
    sunoKey: 'G Minor',
    sunoVocalTags: ['Deep Aggressive Voice', 'Light Autotune', 'Street Raw Delivery', 'Menacing Flow'],
    sunoWeirdness: 30,
    sunoStyleInfluence: 82,
    sunoExcludeStyles: 'no soft R&B, no acoustic folk, no conscious rap, no pop hooks, no cloud rap dreaminess, no slow ballad',
    vocalDNA: 'Deep aggressive male voice with light autotune processing. Raw street delivery — authenticity over polish. Menacing flow with occasional melodic moments. Voice carries physical weight and street credibility. Ad-libs percussive and signature ("ça flingue").',
    flowPattern: 'Aggressive trap flow with street energy. Capable of both rapid delivery and slower menacing passages. Melodic touches on hooks while maintaining aggression. Rhythmic emphasis on strong beats.',
    productionFingerprint: 'Signature: heavy distorted 808 bass, dark synth stabs, trap hi-hat rolls complex, aggressive snare hits, minimal melody — percussion and bass driven, dark atmosphere',
    culturalAnchors: 'Street life, hustle, menace, brotherhood, raw ambition, authentic street culture, no compromise, survival',
    structureDNA: 'Verse 1 (aggressive, street) → Hard hook (simple memorable phrase) → Verse 2 (escalation) → Hook → possible ad-lib heavy outro.',
    hookType: 'Aggressive street chant hook — menacing repetition with light melody',
    vocalPlacement: 'Center-forward aggressive, compressed raw presence',
    energyCurve: 'Constant high aggression with explosive peaks on hooks',
    productionMarkers: 'heavy distorted 808 bass, dark synth stabs minimal, complex trap hi-hat rolls, aggressive hard snare, dark atmospheric production, moderate-high density, bass-driven mix',
    hookStrategy: 'aggressive street phrase hook, menacing repetition, light melodic touch on key phrases, simple impactful, high energy, signature ad-libs',
    verseBehavior: 'aggressive trap flow with street raw energy, rapid delivery capable, menacing slower passages, physical vocal weight, street vocabulary, percussive ad-libs throughout',
    antiPatterns: 'NEVER soft vulnerability. NEVER pop production. NEVER acoustic simplicity. NEVER introspective slow tempo. NEVER clean polished delivery.',
    sunoMetatags: { vocalStyle: 'Aggressive Street Trap', vocalEffect: 'Light Autotune, Compression', mood: 'Menacing, Aggressive, Street Raw', energy: 'High Constant', texture: 'Dark Heavy Bass-Driven', instrument: 'Distorted 808, Dark Synth Stabs, Trap Hi-Hats, Aggressive Snare' }
  },

  'MÉDINE': {
    artist: 'MÉDINE',
    sunoStyleTemplate: 'Conscious French Rap, Political Militant Rap, Intellectual Dense Lyricism, 80-95 BPM, Key: C# Minor, Oriental Orchestral Samples, Dark Piano Chords, Boom-Bap Heavy Drums, Middle-Eastern Melodic Elements, Powerful Commanding Male Voice, Raw No Autotune, Political Fury, 2000s-2020s',
    sunoBpmRange: '80-95',
    sunoKey: 'C# Minor',
    sunoVocalTags: ['Powerful Commanding Voice', 'Dense Articulate Delivery', 'Raw No Autotune', 'Political Conviction'],
    sunoWeirdness: 30,
    sunoStyleInfluence: 90,
    sunoExcludeStyles: 'no autotune, no trap melodies, no pop hooks, no club energy, no light playful delivery, no drill aggression without substance',
    vocalDNA: 'Powerful commanding male voice with dense articulate delivery. ZERO autotune — conviction is the processing. Intellectual density in every bar. Voice shifts between controlled analysis and explosive fury. Middle-Eastern/French cultural duality audible in inflection. Teacher-preacher authority.',
    flowPattern: 'Dense intellectual flow — packed syllables with complex internal rhyme structures. Alternates between measured analysis and impassioned outbursts. Long complex sentences broken by sharp conclusive punches. Multi-layered wordplay requiring multiple listens.',
    productionFingerprint: 'Signature: oriental orchestral samples (oud, strings, percussion), dark piano chords, heavy boom-bap drums, Middle-Eastern melodic elements woven into hip-hop framework, cinematic tension building, occasional spoken-word samples',
    culturalAnchors: 'Political consciousness, Islam and identity, French Republic critique, post-colonial analysis, banlieue intellectual tradition, geopolitics, linguistic warfare, cultural resistance',
    structureDNA: 'Dense verse 1 (16-20 bars, intellectual) → Punchy hook (political slogan) → Verse 2 (escalation, fury) → Hook → Verse 3 possible (conclusion/resolution) → Spoken outro. Three-verse structure common.',
    hookType: 'Political slogan chant hook — militant, memorable, conviction-driven',
    vocalPlacement: 'Center-forward commanding, close-mic raw, voice dominates production',
    energyCurve: 'Building intensity — measured analysis escalates to political fury, peaks on verse climaxes',
    productionMarkers: 'oriental orchestral samples oud strings, dark piano chords minor, heavy boom-bap drums dusty, Middle-Eastern melodic elements, cinematic tension pads, spoken-word samples occasional, moderate density — voice-first',
    hookStrategy: 'political slogan chant hook, militant conviction repetition, memorable as protest chant, NOT melodic — spoken/chanted with force, moderate repetition',
    verseBehavior: 'dense intellectual flow, packed syllables complex internal rhymes, multi-layered wordplay, measured analysis to impassioned outbursts, long sentences to sharp punches, every bar loaded with meaning',
    antiPatterns: 'NEVER autotune. NEVER superficial themes. NEVER pop structure. NEVER melodic trap. NEVER fast drill without content. NEVER playful delivery on serious topics.',
    sunoMetatags: { vocalStyle: 'Political Conscious Dense Rap', vocalEffect: 'No Effects, Raw Natural', mood: 'Militant, Intellectual, Political, Furious', energy: 'Medium-High Building', texture: 'Oriental Boom-Bap Cinematic', instrument: 'Oriental Samples, Oud, Piano, Boom-Bap Drums, Strings' }
  },

  'DINOS': {
    artist: 'DINOS',
    sunoStyleTemplate: 'Introspective French Rap, Jazz-Soul Conscious Rap, Literary Dense Lyricism, 80-95 BPM, Key: Eb Minor, Jazz Piano Chords, Soul Sample Loops, Organic Drums with Swing, Warm Bass, Subtle Strings, Deep Warm Male Voice, No Autotune, Poetic Contemplative, 2010s-2020s',
    sunoBpmRange: '80-95',
    sunoKey: 'Eb Minor',
    sunoVocalTags: ['Deep Warm Male Voice', 'Poetic Delivery', 'No Autotune', 'Contemplative Articulate'],
    sunoWeirdness: 35,
    sunoStyleInfluence: 88,
    sunoExcludeStyles: 'no trap aggression, no drill patterns, no autotune, no club energy, no pop polish, no fast aggressive delivery',
    vocalDNA: 'Deep warm male voice with poetic contemplative delivery. Natural voice — no autotune, no heavy processing. Articulate and precise diction. Emotional range from melancholic introspection to passionate conviction. Literary vocabulary woven into natural delivery. Breathing as punctuation.',
    flowPattern: 'Introspective contemplative flow — measured pace allowing each word to land. Dense internal rhyme schemes. Variation between slow reflective passages and denser rapid sections. Literary construction — sentences unfold like poetry. Never rushed.',
    productionFingerprint: 'Signature: jazz piano chords (extended voicings, 7ths, 9ths), soul sample loops, organic drums with swing (human feel), warm round bass, subtle strings for emotion, occasional saxophone or trumpet, live instrument feel',
    culturalAnchors: 'Existential questioning, generational identity, banlieue intellectual, mental health, family relationships, literary references, personal growth, artistic integrity, time and mortality',
    structureDNA: 'Verse 1 (introspective, building) → Contemplative hook → Verse 2 (deeper, more emotional) → Hook → Bridge (stripped, intimate confession) → Final hook. Structure serves the narrative arc.',
    hookType: 'Contemplative melodic hook — poetic repeated phrase, gentle conviction',
    vocalPlacement: 'Warm intimate, slightly behind the beat, natural room sound',
    energyCurve: 'Slow contemplative burn — intimate start, emotional depth building, bridge strips bare, final verse resolves',
    productionMarkers: 'jazz piano extended chords 7ths 9ths, soul sample loops warm, organic drums with swing human feel, warm round bass, subtle emotional strings, occasional brass accents, moderate-low density, live instrument aesthetic',
    hookStrategy: 'contemplative poetic hook, repeated phrase with emotional weight, gentle melodic conviction, literary memorability, low-moderate repetition, builds emotional resonance on returns',
    verseBehavior: 'introspective contemplative flow, measured pace, dense internal rhyme schemes, literary sentence construction, variation slow to dense, articulate precise diction, breathing as punctuation, never rushed — every word intentional',
    antiPatterns: 'NEVER aggressive drill. NEVER trap production. NEVER autotune. NEVER superficial flex. NEVER fast for speed sake. NEVER club energy.',
    sunoMetatags: { vocalStyle: 'Poetic Contemplative Rap', vocalEffect: 'No Effects, Natural Room', mood: 'Introspective, Melancholic, Poetic, Contemplative', energy: 'Low-Medium Slow Burn', texture: 'Jazz-Soul Organic Warm', instrument: 'Jazz Piano, Soul Samples, Organic Drums, Bass, Strings, Brass' }
  },

  'KALASH CRIMINEL': {
    artist: 'KALASH CRIMINEL',
    sunoStyleTemplate: 'Aggressive French Rap, Hardcore Street Rap, Guttural Raw Energy, 85-100 BPM, Key: D Minor, Dark Heavy 808 Bass, Hard Boom-Bap Drums, Dark Orchestral Stabs, Aggressive Percussion, Deep Guttural Male Voice, Raw No Autotune, Savage Primal Energy, 2010s-2020s',
    sunoBpmRange: '85-100',
    sunoKey: 'D Minor',
    sunoVocalTags: ['Deep Guttural Voice', 'Savage Raw Delivery', 'No Autotune', 'Primal Aggressive Power'],
    sunoWeirdness: 30,
    sunoStyleInfluence: 88,
    sunoExcludeStyles: 'no melodic singing, no soft R&B, no autotune, no pop hooks, no cloud rap, no gentle introspection, no clean polished mix',
    vocalDNA: 'Deep guttural male voice — primal aggressive power. ZERO autotune, ZERO polish — rawness as identity. Guttural cries and growls as ad-libs ("Sauvage"). Voice has physical weight — you FEEL the impact. Capable of controlled menace and explosive rage. Congolese-French duality in delivery.',
    flowPattern: 'Heavy aggressive delivery — each syllable hits like a blow. Capable of both methodical slow menace and explosive rapid bursts. Strong rhythmic emphasis on powerful consonants. Breathing heavy and audible — physical exertion as aesthetic. Short punchy lines alternate with longer menacing passages.',
    productionFingerprint: 'Signature: dark heavy 808 bass (deep, distorted), hard boom-bap drums (massive kick, cracking snare), dark orchestral stabs (strings, brass, choir), aggressive percussion, minimal melody — impact-driven production',
    culturalAnchors: 'Street survival, primal aggression, Congolese identity, "sauvage" aesthetic, brotherhood, prison reality, physical dominance, unapologetic rawness',
    structureDNA: 'Verse 1 (aggressive, heavy) → Hard guttural hook → Verse 2 (escalation, rage) → Hook → possible explosive outro with ad-libs. No soft moments.',
    hookType: 'Guttural aggressive chant — primal repetition, raw animal energy',
    vocalPlacement: 'Center-forward massive, compressed hard, raw dominant presence',
    energyCurve: 'Constant high aggression — relentless primal energy, explosive peaks on key moments',
    productionMarkers: 'dark heavy 808 bass deep distorted, hard boom-bap drums massive kick cracking snare, dark orchestral stabs strings brass, aggressive percussion, minimal melodic content, impact-driven, high density dark mix',
    hookStrategy: 'guttural aggressive chant hook, primal repetition, raw animal energy, simple devastating phrase, maximum impact over melody, explosive delivery',
    verseBehavior: 'heavy aggressive delivery — syllables hit like blows, methodical menace to explosive rage, strong consonant emphasis, heavy audible breathing, short punchy lines to longer menacing passages, physical vocal performance',
    antiPatterns: 'NEVER melodic. NEVER soft. NEVER introspective gently. NEVER autotune. NEVER pop production. NEVER delicate. Must always feel physically HEAVY.',
    sunoMetatags: { vocalStyle: 'Guttural Aggressive Hardcore Rap', vocalEffect: 'No Effects, Heavy Compression', mood: 'Savage, Primal, Aggressive, Dark', energy: 'High Constant Explosive', texture: 'Dark Heavy Impact', instrument: 'Heavy 808, Hard Drums, Orchestral Stabs, Aggressive Percussion' }
  },
...
const CORPUS_CURSORS: Record<string, CursorOverrides> = {
  ...
  // ── SPRINT 7 — NEW ARTIST CURSORS ──
  'KERY JAMES': { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'narrative-real',  referenceDensity: 85, technicityMode: 'virtuoso',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'conscient-jazz-soul' },
  SOFIANE:      { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'narrative-real',  referenceDensity: 40, technicityMode: 'standard',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'street-boom-bap-raw' },
  ZIAK:         { compositionMode: 'hook-driven',  registerMode: 'combative',     conceptualMode: 'non-narrative',   referenceDensity: 15, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'fast', harmonicProfileId: 'jersey-drill-bounce' },
  FAVÉ:         { compositionMode: 'melody-first', registerMode: 'hybrid',        conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'implicit', tempoGravity: 'fast', harmonicProfileId: 'jersey-drill-bounce' },
  '1PLIKE140':  { compositionMode: 'text-first',   registerMode: 'combative',     conceptualMode: 'non-narrative',   referenceDensity: 25, technicityMode: 'virtuoso',         honorCode: 'implicit', tempoGravity: 'fast', harmonicProfileId: 'drill-fr-cold' },
  'LAURYN HILL':{ compositionMode: 'melody-first', registerMode: 'contemplative', conceptualMode: 'narrative-real',  referenceDensity: 80, technicityMode: 'virtuoso',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'neo-soul-uk-rnb' },
  GUY2BEZBAR:   { compositionMode: 'hook-driven',  registerMode: 'combative',     conceptualMode: 'non-narrative',   referenceDensity: 20, technicityMode: 'standard',         honorCode: 'central',  tempoGravity: 'mid',  harmonicProfileId: 'mystic-orchestral-808' },
